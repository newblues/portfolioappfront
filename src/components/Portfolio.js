          ...
          >
            ...
            <div className="project">
              <p className="text-center">
                JSON Viewer is a web-based single page tool for viewing, formatting, and validating
                JSON and some advance features like loading external json api urls and error
                handling. It also gives developers the ability to generate the path to any value
                with a single click. Build Tools : Jsx, React, jest and enzyme, Css(SASS, SMACSS
                Architecture), @react-ace Editor, NPM , YARN, babel, etc.
              </p>
