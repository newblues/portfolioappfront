...
class Project extends React.Component {
  ...
  render() {
    const stackFront = this.props.stack_front.map((e, i) => {
      return (
    ...
    const stackBack = this.props.stack_back.map((e, i) => {
      return (
        <Badge key={i} color="secondary" style={{ padding: 5, margin: 5 }}>
          {e}
        </Badge>
      ...
      <Col id="portfolio" xs="12" md="6" lg="4">
        <Card className={classes.card}>
          <CardHeader
            ...
            avatar={
              <Avatar aria-label="Recipes" src={this.props.pic_url} className={classes.avatar} />
            }
            //   action={
            //     <IconButton>
            //       <MoreVertIcon />
